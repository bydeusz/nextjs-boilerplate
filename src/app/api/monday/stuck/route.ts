        ...
        query: `
          mutation {
            change_multiple_column_values(
              board_id: 3822650183,
              item_id: ${id},
              column_values: "{\\"text8\\": \\"${width}\\", \\"text13\\": \\"${height}\\", \\"color5\\": {\\"index\\":16,\\"post_id\\":null,\\"changed_at\\":\\"${new Date().toISOString()}\\"}, \\"long_text8\\": {\\"text\\": \\"${note}\\", \\"changed_at\\": \\"${new Date().toISOString()}\\"}}"
            ) {
              id
            }
          }
